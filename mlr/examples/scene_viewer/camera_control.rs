...
impl Default for Camera {
    fn default() -> Self {
        Camera {
            ...
            view: glam::Mat4::look_at_rh(glam::vec3(0.0, 0.0, -1.0), glam::vec3(0.0, 0.0, 0.0), glam::Vec3::Y),
...
impl CameraControl {
    pub fn new(width: f64, height: f64) -> CameraControl {
        CameraControl {
            fov_y_radians: std::f64::consts::PI / 2.0,
            z_near: 0.001,
            z_far: 10.0,
            zoom: 1.0,
            screen_size: glam::dvec2(width, height),
            cursor_pos: None,
            frame: CameraFrame {
    ...
    pub fn set_screen_size(&mut self, width: f64, height: f64) {
        self.screen_size = glam::dvec2(width, height);
    }
    ...
    pub fn center_on_bounds(&mut self, bounds: &AABB, fov_y_radians: f64) {
        ...
        let new_center: glam::DVec3 = bounds.center().as_dvec3();
